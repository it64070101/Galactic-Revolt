...
def ship_hud2(screen, ship): #สร้างหน้าบอก Resource
    ...
    screen.blit(text("HULL: "+("O"*ship['hull'][0])+"-"*(ship['hull'][1]-ship['hull'][0]), UIfont, 28, black), (45, 75))
    screen.blit(text(" %02d %s " %(ship['man'], man), UIfont, 28, green), (704, 640))
    screen.blit(text(" %d/%d %s " %(ship['red'][0], ship['red'][1], red), UIfont, 28, black), (704, 672))
    screen.blit(text(" %d/%d %s " %(ship['blue'][0], ship['blue'][1], blue), UIfont, 28, black), (704, 704))
    screen.blit(text(" %d/%d %s " %(ship['yellow'][0], ship['yellow'][1], yellow), UIfont, 28, black), (704, 736))
